          ...
          <div className="bio__left">
            ...
            <div className="bio__text-background">
              <p>
                ...
                deployed my first consumer-facing website in 2013 after
                completing courses from CodeAcademy in HTML, CSS, JS, and PHP.
                During that time I also dove into a CS fundamentals textbook ,
                where I wrote a bunch of programs with Ruby. 5 years later I
                ...
                quickly, as well as the ability to self-manage, taking 100%
                ...
                production ready code, and I am a certified git ninja. When I am
                not writing code, you can find me climbing, playing jazz piano,
                jamming on guitar, or producing electronic music under the
                moniker{" "}
                <BioLink
